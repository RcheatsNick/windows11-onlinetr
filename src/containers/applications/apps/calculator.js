      ...
      <div className="windowScreen flex flex-col" data-dock="true">
        <div className="flex pt-2">
          <div className="flex pl-2 items-center">
            ...
            <div className="mx-4 font-semibold pb-1">Standart</div>
          </div>
        </div>
        <div className="restWindow h-full flex-grow flex">
          ...
          <div className="calcHis flex flex-col">
            <div className="text-sm font-semibold">Geçmiş</div>
            {hist.length!=0?null:
              <div className="text-xs mt-4">Henüz bir geçmiş yok</div>
            }
